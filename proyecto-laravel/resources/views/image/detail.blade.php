...
382. Formulario de comentarios
384. Mejoras en la validación
386. Listar comentarios
395. Like en el detalle
401. Botones de las imagenes
402. Eliminar imagen
-->
            ...
            <div class="card pub_image pub_image_detail">
                ...
                <div class="card-body">
                    ...
                    <div class="likes">
                        ...
                        @if($user_like)
                            <img src="{{ asset('img/hearts-red-64.png') }}" data-id="{{ $image->id }}" class="btn-dislike"/>
                        @else
                            <img src="{{ asset('img/hearts-black-64.png') }}" data-id="{{ $image->id }}"  class="btn-like"/>
                        @endif
